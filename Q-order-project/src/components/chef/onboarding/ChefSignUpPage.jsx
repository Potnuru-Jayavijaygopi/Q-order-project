...
import './ChefSignUpPage.css';

const ChefSignUpPage = ({ onSignUpSuccess, onBackToLogin, onRoleChange }) => {
  ...
  const handleInputChange = (field, value) => {
    ...
    if (field === 'role' && value !== 'Chef' && onRoleChange) {
      onRoleChange(value);
    }
  };
  ...
  return (
    <div className="chef-signup-page-wrapper">
      <div className="chef-signup-card-container">
        {onBackToLogin && (
          <button className="chef-signup-back-btn" onClick={onBackToLogin} aria-label="Go back">
            <ChevronLeft size={24} />
          </button>
        )}

        <h1 className="chef-signup-title">Sign Up</h1>
        <p className="chef-signup-subtitle">Please sign up to get started</p>

        <form onSubmit={handleSubmit} className="chef-signup-form">
          ...
          <div className="input-field-group">
            <input
              type="text"
              placeholder="Specialty / Cuisine (e.g. Indian, Chinese, Italian)"
