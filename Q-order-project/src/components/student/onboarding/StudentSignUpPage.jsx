...
const StudentSignUpPage = ({ onSignUpSuccess, onBackToUniversity, onRoleChange }) => {
  ...
  const handleInputChange = (field, value) => {
    ...
    if (field === 'role' && value !== 'Student' && onRoleChange) {
      onRoleChange(value);
    }
  };
  ...
  return (
    <div className="student-signup-page-wrapper">
      <div className="student-signup-card-container">
        {onBackToUniversity && (
          <button className="student-signup-back-btn" onClick={onBackToUniversity} aria-label="Go back">
            <ChevronLeft size={24} />
          </button>
        )}

        <h1 className="student-signup-title">Sign Up</h1>
        <p className="student-signup-subtitle">Please sign up to get started</p>
